...
HD_PWD='/home/it/01Design_repo/lab02/Tas3_lab2/Tas3_lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_Adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sub_Adder.tcl -notrace
