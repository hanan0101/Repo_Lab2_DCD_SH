...
HD_PWD='/home/it/01Design_repo/lab02/Tas3_lab2/Tas3_lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_Adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_Adder.tcl
